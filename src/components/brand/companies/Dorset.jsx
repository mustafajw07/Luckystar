    ...
    return (
        ...
        <div className="row justify-content-center">
          ...
          <Card title = "Digital lock" description = "Digital Lock BLE DG 801 MGM WITH CLOUD KEY" price = "MRP:- 47150/-" dis = "Discount :- 35%" gst = "18% - Gst Extra" img = {digital}/>
            <Card title = "Door closer" description = "Door closer 80KG" price = "MRP:- 3090/-" dis = "Discount :- 35%" gst = "18% - Gst Extra" img = {fs80}/>
            <Card title = "Door closer" description = "Door closer 120KG" price = "MRP:- 6120/-" dis = "Discount :- 35%" gst = "18% - Gst Extra" img = {fs120}/>
